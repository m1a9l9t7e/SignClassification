...
def conv2d_bn(x, nb_filter, nb_row, nb_col,
    ...
    # TODO OPTIONAL: set trainable = true to train from scratch
    x = Convolution2D(nb_filter, nb_row, nb_col,
                      subsample=subsample,
                      border_mode=border_mode,
                      bias=bias, trainable=False)(x)
...
def block_inception_b(input):
    ...
    # TODO OPTIONAL: set trainable = true to train from scratch
    branch_3 = AveragePooling2D((3, 3), strides=(1, 1), border_mode='same', trainable=False)(input)
